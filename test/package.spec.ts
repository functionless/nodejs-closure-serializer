...
describe("module", () => {
  it("remaps exports correctly for mockpackage", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("mockpackage/lib/index.js"),
      "mockpackage"
    );
  });
...
describe("disregard null targets", () => {
  ...
  it("handles wildcard paths", () => {
    assert.strictEqual(
      pkg.getModuleFromPath(
        "es-module-package/src/features/private-inter.js",
        packagedef
      ),
    ...
    assert.strictEqual(
      pkg.getModuleFromPath(
        "es-module-package/src/features/y/z/foo/bar/baz.js",
        packagedef
      ),
  ...
  it("handles whitelisting blacklisted directories", () => {
    assert.strictEqual(
      pkg.getModuleFromPath(
        "es-module-package/features/internal/public/index.js",
        {
          name: "es-module-package",
          exports: {
...
describe("basic package exports", () => {
  ...
  it("handles multiple aliases 1", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/lib/index.js", packagedef),
      "my-mod/lib/index.js"
    );
  });
  it("handles multiple aliases 2", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/feature/index.js", packagedef),
      "my-mod/feature/index.js"
    );
  });
  it("returns with no modification", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/package.json", packagedef),
      "my-mod/package.json"
    );
  });
});
describe("wildcard package exports", () => {
  ...
  it("wildcard module", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/lib/foobar.js", packagedef),
      "my-mod/lib/foobar"
    );
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/lib/foo.js.js", packagedef),
      "my-mod/lib/foo.js"
    ); // check
    assert.strictEqual(
      pkg.getModuleFromPath("my-mod/feature/foobar.js", packagedef),
      "my-mod/feature/foobar"
    );
  });
...
describe("conditional import/require package exports", () => {
  ...
  it("remaps conditional node/default nested packages", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("that-mod/main.js", packagedef),
      "that-mod"
    );
    assert.strictEqual(
      pkg.getModuleFromPath("that-mod/feature-node.js", packagedef),
      "that-mod/feature"
    );
    assert.strictEqual(
      pkg.getModuleFromPath("that-mod/feature.js", packagedef),
      "that-mod/feature"
    );
  });
});
describe("conditional import/require package exports", () => {
  ...
  it("remaps to main pkg", () => {
    assert.throws(() =>
      pkg.getModuleFromPath("this-mod/main-module.js", packagedef)
    );
    assert.strictEqual(
      pkg.getModuleFromPath("this-mod/main-require.cjs", packagedef),
      "this-mod"
    );
  });
});
...
describe("error cases", () => {
  it("returns the original module if package.json not found", () => {
    assert.strictEqual(
      pkg.getModuleFromPath("this-mod/main-require.cjs"),
      "this-mod/main-require.cjs"
    );
  });
});
